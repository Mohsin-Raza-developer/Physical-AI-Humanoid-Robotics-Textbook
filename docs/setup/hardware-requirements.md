...
sidebar_position: 1
description: Hardware specifications and equipment needed for the Physical AI Humanoid Robotics course
---
...
- Review [Software Setup](./software-setup) for installation instructions
- Explore [Lab Infrastructure](./lab-infrastructure) for on-premise vs. cloud options
- Check the [Student Kit Guide](./student-kit-guide) for the Economy Jetson setup
